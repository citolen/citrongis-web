...
Cluster.prototype._initialize = function () {
    ...
    for (var i = 0; i <= this._maxZoom; ++i) {
        this._clusterGrids[i] = new ClusterGrid(120 * C.Viewport.getResolutionAtZoomLevel(i));
        this._unclusterGrids[i] = new ClusterGrid(120 * C.Viewport.getResolutionAtZoomLevel(i));
    }
};
