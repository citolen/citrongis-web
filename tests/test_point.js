...
console.log("Benchmark with 100000 conversions");

console.time("bench");
var pInRDNew;
for (var i = 0; i < 100000; i++) {
    pInRDNew = C.Helpers.CoordinatesHelper.Transform(p, projRDNew);
}

console.timeEnd("bench");

console.log("Bench with 1 conversion");

console.time("bench");
pInRDNew = C.Helpers.CoordinatesHelper.Transform(p, projRDNew);
console.timeEnd("bench");
console.log(pInRDNew.toString());
